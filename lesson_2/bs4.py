...
class HHru:
    ...
    def get_page(self):
        ...
        try:
            re = requests.get(self.url_main + self.url_search, headers=headers)
...
if __name__ == '__main__':
    work = input('Enter the title of the work: ')
    region = 'naberezhnye'
    hh = HHru(work, region)
